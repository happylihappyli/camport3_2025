...
REM Run scons with the fixed minimal SConstruct file
scons -f SConstruct_Minimal_Fixed

REM Check if compilation was successful
if exist "bin\MinimalTYTest.exe" (
    echo Success: MinimalTYTest.exe has been generated
    echo Path: e:\github\camport3_2025\sample\bin\MinimalTYTest.exe
) else (
...
cd bin
dir MinimalTYTest.exe PointCloud*.exe